...
public class MobileNavbarDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MobileNavbarDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
